 ...
 *
 * @returns The core table name (e.g., "trustkeep-core-dev")
 ...
 *
 * @returns The base table name (e.g., "trustkeep-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "trustkeep-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "trustkeep-app-realtime-dev")
