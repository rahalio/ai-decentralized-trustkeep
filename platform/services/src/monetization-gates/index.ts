/**
 * MonetizationGates Services - Application Layer Export
 *
...
/**
 * MonetizationGates Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for monetization-gates domain.
 */
