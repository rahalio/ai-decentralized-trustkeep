/**
 * BreachPlaybooks Services - Application Layer Export
 *
...
/**
 * BreachPlaybooks Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for breach-playbooks domain.
 */
